...
// Fri Apr 29 13:50:11 2022 by ROOT version 6.24/06
// from TTree beamana/beam analysis tree
// found on file: protoDUNE_mc_reco_flattree_prod4a_ntuple_6GeV.root
//////////////////////////////////////////////////////////

#ifndef MC_Prod4a_ntuple_6GeV_h
#define MC_Prod4a_ntuple_6GeV_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<double>  *reco_daughter_allShower_calibrated_energy;
   ...
   TBranch        *b_for_truncation_method;   //!
   ...
   TBranch        *b_reco_daughter_allShower_calibrated_energy;   //!
   ...
   MC_Prod4a_ntuple_6GeV(TTree *tree=0);
   virtual ~MC_Prod4a_ntuple_6GeV();
...
#ifdef MC_Prod4a_ntuple_6GeV_cxx
MC_Prod4a_ntuple_6GeV::MC_Prod4a_ntuple_6GeV(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("protoDUNE_mc_reco_flattree_prod4a_ntuple_6GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("protoDUNE_mc_reco_flattree_prod4a_ntuple_6GeV.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("protoDUNE_mc_reco_flattree_prod4a_ntuple_6GeV.root:/pduneana");
...
MC_Prod4a_ntuple_6GeV::~MC_Prod4a_ntuple_6GeV()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MC_Prod4a_ntuple_6GeV::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MC_Prod4a_ntuple_6GeV::LoadTree(Long64_t entry)
{
...
void MC_Prod4a_ntuple_6GeV::Init(TTree *tree)
{
   ...
   reco_daughter_allShower_calibrated_energy = 0;
   ...
   fChain->SetBranchAddress("for_truncation_method", &for_truncation_method, &b_for_truncation_method);
   ...
   fChain->SetBranchAddress("reco_daughter_allShower_calibrated_energy", &reco_daughter_allShower_calibrated_energy, &b_reco_daughter_allShower_calibrated_energy);
...
Bool_t MC_Prod4a_ntuple_6GeV::Notify()
{
...
void MC_Prod4a_ntuple_6GeV::Show(Long64_t entry)
{
...
Int_t MC_Prod4a_ntuple_6GeV::Cut(Long64_t entry)
{
...
#endif // #ifdef MC_Prod4a_ntuple_6GeV_cxx
