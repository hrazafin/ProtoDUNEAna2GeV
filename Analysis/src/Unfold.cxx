...

{
  ...
  response_SliceID_BeamInt.UseOverflow(false);
  response_SliceID_Inc.UseOverflow(false);
  response_SliceID_Ini.UseOverflow(false);
  response_SliceID_Pi0KE.UseOverflow(false);
  response_SliceID_Pi0CosTheta.UseOverflow(false);
...
void Unfold::SaveHistograms(){
  ...
  TH2D *hbeamint = (TH2D*)response_SliceID_BeamInt.Hresponse();
