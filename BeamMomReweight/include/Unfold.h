...
class Unfold {
 ...
 public:
  ...
  RooUnfoldResponse response_Int;  //Interaction
  RooUnfoldResponse response_BeamInt;  //Interaction

  RooUnfoldResponse response_Inc;  //Incident
  RooUnfoldResponse response_Ini;  //Initial

  RooUnfoldResponse response_Pi0KE;
  RooUnfoldResponse response_Pi0CosTheta;
  RooUnfoldResponse response_Pi0Theta;
