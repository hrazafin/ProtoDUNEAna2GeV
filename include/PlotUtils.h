...
class PlotUtils
{
  ...
  void DrawHist(TList *lout, const double plotscale, const double plotscale_wt, TList * overlayList, const TString outdir);
  ...
  void IniColorCB();
  void SetColor();
  int GetColor(const int col, const bool alpha = false);
